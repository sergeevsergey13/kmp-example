...
@NonNullApi
public class CatFactsProjectDependency extends DelegatingProjectDependency {

    @Inject
    public CatFactsProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
