...
@interface SharedFactModel : SharedBase
@property (readonly) NSString * _Nullable factText __attribute__((swift_name("factText")));
@property (readonly) int64_t id __attribute__((swift_name("id")));
- (instancetype)initWithFactText:(NSString * _Nullable)factText id:(int64_t)id __attribute__((swift_name("init(factText:id:)"))) __attribute__((objc_designated_initializer));
- (SharedFactModel *)doCopyFactText:(NSString * _Nullable)factText id:(int64_t)id __attribute__((swift_name("doCopy(factText:id:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FactController")))
@interface SharedFactController : SharedBase
@property (class, readonly, getter=shared) SharedFactController *shared __attribute__((swift_name("shared")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> factFlow __attribute__((swift_name("factFlow")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)factController __attribute__((swift_name("init()")));
@end
